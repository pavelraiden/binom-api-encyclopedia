...
Retrieves complete information about a specific affiliate network including all configuration parameters, postback settings, payout relations, and current status. Essential for auditing and managing existing networks.
...
### Workflow Context
Used for: Retrieving network details for campaign setup or auditing
