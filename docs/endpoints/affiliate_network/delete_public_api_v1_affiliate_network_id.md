...
Delete Affiliate Network. Removes a affiliate_network resource (typically soft delete that can be restored).
...
### Workflow Context
Used for: Removing unused networks (can be restored later)
