...
Rename Affiliate Network. Updates an existing affiliate_network resource with new configuration data.
...
### Workflow Context
Used for: Updating network configuration or postback settings
