...
curl -X POST \
  ...
  "https://pierdun.com/public/api/v1/user/{adminId}/accessible-users?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.post(
    f"{BASE_URL}/public/api/v1/user/{adminId}/accessible-users",
    headers=headers,
    params={
