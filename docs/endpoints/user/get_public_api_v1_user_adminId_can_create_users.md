...
curl -X GET \
  ...
  "https://pierdun.com/public/api/v1/user/{adminId}/can_create_users?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.get(
    f"{BASE_URL}/public/api/v1/user/{adminId}/can_create_users",
    headers=headers,
    params={
