...
curl -X POST \
  ...
  "https://pierdun.com/public/api/v1/report/mark/traffic_source/{id}?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.post(
    f"{BASE_URL}/public/api/v1/report/mark/traffic_source/{id}",
    headers=headers,
    params={
