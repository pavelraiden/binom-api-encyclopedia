...
Creates a new tracking campaign with specified traffic source, cost model, landing pages, and offers. This is the core operation for setting up traffic tracking and requires careful configuration of all routing parameters.
...
- `trafficSourceId` (integer): ID of the traffic source
- `cost` (number): Cost per click/action
