...
Fetches complete campaign configuration including traffic source settings, landing page rotations, offer assignments, cost models, and current status. Critical for campaign management and troubleshooting.
