...
curl -X POST \
  ...
  "https://pierdun.com/public/api/v1/binom/protect/visits/{campaignId}/reset?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.post(
    f"{BASE_URL}/public/api/v1/binom/protect/visits/{campaignId}/reset",
    headers=headers,
    params={
