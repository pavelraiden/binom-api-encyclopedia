...
curl -X POST \
  ...
  "https://pierdun.com/public/api/v1/binom/protect/campaign/{campaignId}/settings?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.post(
    f"{BASE_URL}/public/api/v1/binom/protect/campaign/{campaignId}/settings",
    headers=headers,
    params={
