...
Retrieves comprehensive performance statistics for campaigns including clicks, conversions, costs, revenues, and custom metrics like eCPT, eCPB, trials, and buyouts. Essential for performance analysis and optimization.
