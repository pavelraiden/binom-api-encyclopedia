...
curl -X POST \
  ...
  "https://pierdun.com/public/api/v1/report/simple_filter/{subject}/{uuid}?datePreset=last_7_days&timezone=UTC"
```
...
response = requests.post(
    f"{BASE_URL}/public/api/v1/report/simple_filter/{subject}/{uuid}",
    headers=headers,
    params={
